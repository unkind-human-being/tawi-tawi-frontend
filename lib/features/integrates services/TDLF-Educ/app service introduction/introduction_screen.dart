...
const Color _primaryColor = Color(0xFF0369A1);
const Color _darkColor = Color(0xFF0C4A6E);
const Color _softBg = Color(0xFFE0F2FE);

class TDLFEducIntroductionScreen extends StatelessWidget {
  const TDLFEducIntroductionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ComingSoonIntroductionScreen(
      serviceName: 'TDLF-Educ',
      shortDescription: 'Education tools, learning materials, and school service support.',
