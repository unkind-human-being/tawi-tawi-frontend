...
const Color _primaryColor = Color(0xFFBE185D);
const Color _darkColor = Color(0xFF831843);
const Color _softBg = Color(0xFFFDF2F8);

class TeamRasmanIntroductionScreen extends StatelessWidget {
  const TeamRasmanIntroductionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ComingSoonIntroductionScreen(
      serviceName: 'Team Rasman',
      shortDescription: 'Local app module prepared for future integration.',
