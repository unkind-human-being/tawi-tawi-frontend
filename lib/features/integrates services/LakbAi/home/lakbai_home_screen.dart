...
class LakbaiHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Only show drawer if logged in (which will be always now due to Gateway)
      drawer: isLoggedIn
          ? Drawer(
              backgroundColor: const Color(0xFF022C22),
              child: Column(
                children: [
                  ...
                  // ✅ Changed the Logout button to an info tile since Kawman handles logouts now
                  const ListTile(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 48), // Balances the menu icon to keep "LakbAi" centered
                        ],
                      ),
                    ),
                  ),
