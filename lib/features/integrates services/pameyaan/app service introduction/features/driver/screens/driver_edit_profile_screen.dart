...
class _DriverEditProfileScreenState extends State<DriverEditProfileScreen> {
 ...
 void _updateProfile() async {
    ...
    try {
      // FIXED: Point to the new secure route we just built in Python!
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: const Text('Profile Updated!', style: TextStyle(fontWeight: FontWeight.bold)), backgroundColor: _neonTeal),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(errorMsg, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white)), backgroundColor: Colors.redAccent),
      );
    } finally {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Full Name', style: TextStyle(color: Colors.grey, fontSize: 13, fontWeight: FontWeight.bold)),
