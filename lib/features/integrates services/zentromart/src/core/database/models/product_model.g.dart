...
extension ProductModelByIndex on IsarCollection<ProductModel> {
  Future<ProductModel?> getByBackendId(String backendId) {
    return getByIndex(r'backendId', [backendId]);
  }

  ProductModel? getByBackendIdSync(String backendId) {
  ...
  Future<List<ProductModel?>> getAllByBackendId(List<String> backendIdValues) {
    final values = backendIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'backendId', values);
  }

  List<ProductModel?> getAllByBackendIdSync(List<String> backendIdValues) {
    final values = backendIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByBackendId(ProductModel object) {
    return putByIndex(r'backendId', object);
  }

  Id putByBackendIdSync(ProductModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'backendId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByBackendId(List<ProductModel> objects) {
    return putAllByIndex(r'backendId', objects);
  }

  List<Id> putAllByBackendIdSync(List<ProductModel> objects,
      {bool saveLinks = true}) {
...
extension ProductModelQueryWhereSort
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhere> anyIsSynced() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQueryWhere
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> backendIdEqualTo(
      String backendId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> isSyncedEqualTo(
      bool isSynced) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
...
extension ProductModelQuerySortBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortByBackendId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backendId', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortByBackendIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQuerySortThenBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByBackendId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backendId', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByBackendIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backendId', Sort.desc);
    });
  }
...
extension ProductModelQueryWhereDistinct
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct> distinctByBackendId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQueryProperty
  ...
  QueryBuilder<ProductModel, String, QQueryOperations> backendIdProperty() {
    return QueryBuilder.apply(this, (query) {
