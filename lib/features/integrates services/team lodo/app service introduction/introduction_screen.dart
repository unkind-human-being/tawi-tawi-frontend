...
const Color _primaryColor = Color(0xFF15803D);
const Color _darkColor = Color(0xFF14532D);
const Color _softBg = Color(0xFFF0FDF4);

class TeamLodoIntroductionScreen extends StatelessWidget {
  const TeamLodoIntroductionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ComingSoonIntroductionScreen(
      serviceName: 'Team Lodo',
      shortDescription: 'Community service module prepared for future integration.',
