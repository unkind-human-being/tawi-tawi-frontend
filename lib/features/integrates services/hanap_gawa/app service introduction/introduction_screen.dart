...
const Color _primaryColor = Color(0xFFB45309);
const Color _darkColor = Color(0xFF78350F);
const Color _softBg = Color(0xFFFFFBEB);

class HanapGawaIntroductionScreen extends StatelessWidget {
  const HanapGawaIntroductionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ComingSoonIntroductionScreen(
      serviceName: 'Hanap Gawa',
      shortDescription: 'Local jobs, skilled workers, and service provider matching.',
